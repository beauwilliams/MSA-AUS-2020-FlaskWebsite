 ...
 *
 */
export declare type RenderableFunction<Renderable, Tag, NodeType extends Node = Node, Renderer extends RendererLike<Renderable, Tag> = RendererLike<Renderable, Tag>> = (renderer: Renderer) => NodeType;
/**
 *
...
export interface RendererLike<Renderable, Tag> {
    create(tag: string | Tag, props: PropsType<Renderable | RawValue> | undefined, ...children: (Renderable | RawValue | Node)[]): Node;
