...
export declare function rxjsPlugins<R, T>(): (ObservablePlugin<R, T> | ObservableClassPlugin<R, T> | ObservableObjectValuePlugin<R, T> | ObservableInnerHTMLPlugin<R, T> | SubjectEventHandlerPlugin<R, T> | InputSubjectPlugin<R, T> | CompInputSubjectPlugin<R, T> | CompOutputObservablePlugin<R, T> | CompOutputObservableEventsPlugin<R, T> | CompContextSubjectPlugin<R, T> | DefaultSubjectRecipientPlugin<R, T>)[];
export { ObservablePlugin, ObservableClassPlugin, ObservableObjectValuePlugin, ObservableInnerHTMLPlugin, SubjectEventHandlerPlugin, InputSubjectPlugin, CompInputSubjectPlugin, CompContextSubjectPlugin, CompOutputObservablePlugin, CompOutputObservableEventsPlugin, DefaultSubjectRecipientPlugin, };
