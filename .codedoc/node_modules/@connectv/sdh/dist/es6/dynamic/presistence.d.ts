 ...
 *
 */
export declare function saveBundle(bundle: Bundle, config?: Configuration): Promise<Bundle>;
/**
 *
 ...
 *
 */
export declare function loadBundle(path: string, url?: string): Promise<Bundle>;
