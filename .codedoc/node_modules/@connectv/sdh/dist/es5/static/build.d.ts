 ...
 *
 */
export declare type BuildFunc<T> = (t: T, renderer: StaticRenderer, file: File<T>, document: Document) => Node | Promise<Node>;
/**
 *
 ...
 *
 */
export declare type PluginBuilder<T, R = any, Tag = any> = (f: File<T>) => Plugin<R, Tag>;
/**
 *
 ...
 *
 */
export declare type PluginListBuilder<T, R = any, Tag = any> = (f: File<T>) => Plugin<R, Tag>[];
/**
 *
 ...
 *
 */
export declare function build<T>(builder: BuildFunc<T>): Function<File<T>, File<Compiled>>;
/**
 *
 * Convenience function for rxline files. Returns a transform that converts the content
 * of an rxline `File<T>` using the given `BuildFunc<T>` to a file whose content
 ...
 *
 */
export declare function build<T>(builder: BuildFunc<T>, ...plugins: (PluginBuilder<T> | Plugin<any, any>)[]): Function<File<T>, File<Compiled>>;
/**
 *
 ...
 *
 */
export declare function post(processor: PostProcessor): Function<File<Compiled>, File<Compiled>>;
/**
 *
 ...
 *
 */
export declare function serialize(): Function<File<Compiled>, File<string>>;
/**
 *
 ...
 *
 */
export declare function saveCompiledFile(): Function<File<Compiled>, File<string>>;
