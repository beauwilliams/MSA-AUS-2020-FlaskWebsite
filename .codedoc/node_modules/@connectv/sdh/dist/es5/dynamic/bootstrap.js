...
var create_entry_1 = require("./create-entry");
var modularize_1 = require("./modularize");
/**
 *
...
function bootstrap(bundle) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, dir, name, entryPath;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = path_1.parse(bundle.path), dir = _a.dir, name = _a.name;
                    entryPath = path_1.join(dir, name + '.entry.js');
                    modularize_1.modularize(bundle);
                    return [4 /*yield*/, create_entry_1.createEntry(entryPath, bundle.imports, bundle.rendererImport, bundle.initImports)];
                case 1:
                    _b.sent();
