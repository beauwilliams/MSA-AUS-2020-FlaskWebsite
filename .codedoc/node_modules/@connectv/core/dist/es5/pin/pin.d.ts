 ...
 *
 */
export declare class Pin extends Connectible {
    /**
     *
     ...
     *
     */
    protected isLocked(observable: Observable<Emission> | undefined): boolean;
    /**
     *
     ...
     *
     */
    protected shouldResolve(_: PinLike[], observable: Observable<Emission> | undefined): boolean;
    /**
     *
 ...
 *
 */
export declare function pin(): Pin;
export default pin;
