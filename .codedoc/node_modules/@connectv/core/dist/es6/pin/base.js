 ...
 *
 */
export class BasePin extends Tracker {
    /**
     *
    ...
    subscribe(observerOrNext, error, complete) {
        if (error || complete)
            return this.track(this.observable.pipe(map((e) => e.value)).subscribe(observerOrNext, error, complete));
        else
            return this.track(this.observable.pipe(map((e) => e.value)).subscribe(observerOrNext));
    }
}
